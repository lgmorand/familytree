...
{
    /// <summary>
    /// Representation for a single serializable Person. INotifyPropertyChanged allows properties of
    /// the Person class to participate as source in data bindings.
    /// </summary>
    [Serializable]
    public class Person : INotifyPropertyChanged, IEquatable<Person>, IDataErrorInfo
    {
        ...
        /// <summary>
        /// Gets or sets the text that appear behind the last name providing additional information
        /// about the person.
        /// </summary>
        ...
        // if (photos != null && photos.Count > 0) { foreach (Photo photo in photos) { if
        // (photo.IsAvatar) return photo.FullyQualifiedPath; } }
        ...
        public bool IsDeletable
        {
            get
            {
                ...
                // More than 3 relationships. The relationships are from siblings. Deletable since
                // siblings are connected to each other or the parent.
        ...
        /// <summary>
        /// Accessor for the person's half siblings. A half sibling is a person that contains one or
        /// more same parents as the person, but does not contain all of the same parents.
        /// </summary>
        [XmlIgnore]
        public Collection<Person> HalfSiblings
        {
            get
            {
                ...
                // Iterate through each parent, and determine if the parent's children are half siblings.
    ...
    public class ParentSet : IEquatable<ParentSet>
    {
        ...
        #endregion IEquatable<ParentSet> Members
    }

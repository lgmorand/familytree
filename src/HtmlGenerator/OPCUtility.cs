...
namespace HtmlGenerator
{
    ...
    /// NOTE: This class is based on the PackageWrite and PackageRead samples in the Microsoft
    ///       Windows SDK. It has been extended to work with directories and additional file formats
    /// such as jpegs and rtf.
    /// </summary>
    public class OPCUtility
    {
        ...
        #endregion Write Package

        #region ReadPackage

        /// <summary>
        /// Extracts content and resource parts from a given Package zip file to a specified target directory.
        /// </summary>
        ...
        public static void ExtractPackage(string packagePath, string targetDirectory)
        {
            try
            {
                // Create a new Target directory. If the Target directory exists, first delete it and
        ...
        /// <param name="targetDirectory">The absolute path to the targer folder.</param>

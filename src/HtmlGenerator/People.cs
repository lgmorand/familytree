...
{
    /// <summary>
    /// Argument that is passed with the ContentChanged event. Contains the person that was added to
    /// the list. The person can be null.
    /// </summary>
    ...
    /// Properties are not serialized in a class that is derived from a collection class (as the
    /// PeopleCollection class is). Therefore the People collection is contained in this class, along
    /// with other important properties that need to be serialized.
    /// </summary>
    [XmlRoot("Family")]
    ...
    public class People
    {
        ...
        // circular references during Xml Serialization. When family data is loaded, the
        // corresponding person object will be assigned to the current property (please see
        // app.xaml.cs). The currentPersonId is set in the Save method of this class.
        private string currentPersonId;

        // Store the person's name with the Id to make the xml file more readable. The
        // currentPersonName is set in the Save method of this class.
        private string currentPersonName;

        // The fully qualified path and filename for the family file.
        private string fullyQualifiedFilename;

        // Version of the file. This is not used at this time, but allows a future version of the
        // application to handle previous file formats.
            ...
            try
            {
                ...
                using (Stream stream = new FileStream(this.FullyQualifiedFilename, FileMode.Open, FileAccess.Read, FileShare.Read))
                {
                    ...
                    foreach (Person p in this.PeopleCollection)
                    {
                        ...
                        // person Id is seralized to express relationships. When family data is
                        // loaded, the correct person object is found using the person Id and
                        // assigned to the appropriate relationship.
                        ...
                        // // Remove spaces since they'll be packaged as %20, breaking relative paths
                        // that expect spaces photoFile = photoFile.Replace(" ", "");
                        ...
                        // // Remove spaces since they'll be packaged as %20, breaking relative paths
                        // that expect spaces storyFile = ReplaceEncodedCharacters(storyFile);
    ...
    public class PeopleCollection : ObservableCollection<Person>, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// A person or relationship was added, removed or modified in the list. This is used instead
        /// of CollectionChanged since CollectionChanged can be raised before the relationships are
        /// setup (the Person was added to the list, but its Parents, Children, Sibling and Spouse
        /// collections have not been established). This means the subscriber (the diagram control)
        /// will update before all of the information is available and relationships will not be displayed.
        ///
        /// The ContentChanged event addresses this problem and allows the flexibility to raise the
        /// event after *all* people have been added to the list, and *all* of their relationships
        /// have been established.
        ///
        /// Objects that add or remove people from the list, or add or remove relationships should
        /// call OnContentChanged when they want to notify subscribers that all changes have been made.
        /// </summary>
        ...
        /// <summary>
        /// Adds Parent-Child relationship between person and child with the provided parent-child
        /// relationship type.
        /// </summary>
        ...
        /// <summary>
        /// Add Spouse relationship between the person and the spouse with the provided spouse
        /// relationship type.
        /// </summary>
        ...
        #endregion Add new people / relationships

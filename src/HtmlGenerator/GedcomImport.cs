...
namespace HtmlGenerator
{
    ...
    public class GedcomImport
    {
        ...
        // Convert the GEDCOM file to an XML file which is easier to parse, this contains the GEDCOM
        // info in an XML format.
        ...
        private void ImportFamilies()
        {
            ...
            foreach (XmlNode node in list)
            {
                ...
                // Get the Person objects for the husband and wife, required for marriage info and
                // adding children.
                ...
                foreach (string child in children)
                {
                    ...
                    // Calling RelationshipHelper.AddChild hooks up all of the child relationships
                    // for the husband and wife. Also hooks up the sibling relationships.
